Contributing to PIPO Core
============================

The PIPO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the PIPO Core project, and is not to be
confused with overall PIPO Network Protocol consensus changes.

Whether a pull request is merged into PIPO Core rests with the project merge
...
Patches that change PIPO consensus rules are considerably more involved than
...
Where a patch set proposes to change the PIPO consensus, it must have been
...
The project leader is the release manager for each PIPO Core release.
