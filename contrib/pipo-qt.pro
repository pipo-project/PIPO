...
RESOURCES += src/qt/pipo.qrc src/qt/pipo_locale.qrc

TRANSLATIONS += src/qt/locale/pipo_bg.ts \
                src/qt/locale/pipo_de.ts \
                src/qt/locale/pipo_en.ts \
                src/qt/locale/pipo_es.ts \
                src/qt/locale/pipo_fi.ts \
                src/qt/locale/pipo_fr.ts \
                src/qt/locale/pipo_it.ts \
                src/qt/locale/pipo_ja.ts \
                src/qt/locale/pipo_pl.ts \
                src/qt/locale/pipo_pt.ts \
                src/qt/locale/pipo_ru.ts \
                src/qt/locale/pipo_sk.ts \
                src/qt/locale/pipo_sv.ts \
                src/qt/locale/pipo_vi.ts \
                src/qt/locale/pipo_zh_CN.ts \
                src/qt/locale/pipo_zh_TW.ts
