...
In order to support loading of multiple wallets in pipo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pipo.cpp.
...
Changes to pipo.cpp
----------------------
pipo.cpp is the entry point into pipo-qt, and as such, will require some minor modifications to provide hooks for
