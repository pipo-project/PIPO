...
/* Pipo GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PIPO"
#define QAPP_ORG_DOMAIN "pipo.online"
#define QAPP_APP_NAME_DEFAULT "PIPO-Qt"
#define QAPP_APP_NAME_TESTNET "PIPO-Qt-testnet"
