...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIPO features */
        {"pipo", "listmasternodes", &listmasternodes, true, true, false},
        {"pipo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pipo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pipo", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"pipo", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"pipo", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"pipo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pipo", "masternodedebug", &masternodedebug, true, true, false},
        {"pipo", "startmasternode", &startmasternode, true, true, false},
        {"pipo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pipo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pipo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pipo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pipo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pipo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pipo", "preparebudget", &preparebudget, true, true, false},
        {"pipo", "submitbudget", &submitbudget, true, true, false},
        {"pipo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pipo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pipo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pipo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pipo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pipo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pipo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pipo", "checkbudgets", &checkbudgets, true, true, false},
        {"pipo", "mnsync", &mnsync, true, true, false},
        {"pipo", "spork", &spork, true, true, false},
        {"pipo", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> pipo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50163/\n";
}
